...
from appusers.forms import UserForm,UserProfileInfoForm
...
def register(request):
    ...
    return render(request,'appusers/registration.html',{'registered':registered,'user_form':user_form,'profile_form':profile_form})
